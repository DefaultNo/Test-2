(() => {
    ...
    function initSliders() {
        if (document.querySelector(".top-swiper")) {
            let thumbs = new core(".bottom-swiper", {
            ...
            new core(".top-swiper", {
                ...
                navigation: {
                    prevEl: ".bottom-swiper__button_prev",
                    nextEl: ".bottom-swiper__button_next"
                },
                on: {}
            });
        }
        if (document.querySelector(".top-services__swiper")) {
            let thumbsServices = new core(".top-services__swiper", {
            ...
            new core(".content-services", {
                ...
                watchSlidesProgress: true,
                thumbs: {
                    swiper: thumbsServices
                },
                navigation: {
                    prevEl: ".top-services__button_prev",
                    nextEl: ".top-services__button_next"
                },
                on: {}
            });
        }
    ...
    const burger = document.querySelector(".top-header__burger"), menu = document.querySelector(".menu");
